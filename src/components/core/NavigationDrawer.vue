  ...
  <v-navigation-drawer
    ...
    <v-list>
      ...
      <v-list-tile @click="changeRoute('Calendar', 2)">
        ...
        <v-list-tile-title :class="[{'active': selectedIndex === 2}, 'item-title' ]"> {{ $t('Schedule') }}</v-list-tile-title>
      </v-list-tile>

      <v-list-tile @click="changeRoute('Employees', 3)">
        <v-list-tile-action>
          <v-icon>mail</v-icon>
        </v-list-tile-action>
        <v-list-tile-title :class="[{'active': selectedIndex === 3}, 'item-title' ]">{{ $t('Employees') }}</v-list-tile-title>
      </v-list-tile>

      <v-list-group
        prepend-icon="pageview">
        <v-list-tile slot="activator">
          <v-list-tile-title class="item-title">{{ $t('Warehouse') }}</v-list-tile-title>
        </v-list-tile>
    ...
    <v-list-tile @click="changeRoute('Register', 8)">
        <v-list-tile-action>
          <v-icon>dashboard</v-icon>
        </v-list-tile-action>
        <v-list-tile-title :class="[{'active': selectedIndex === 1}, 'item-title' ]" >{{ $t('Register') }}</v-list-tile-title>
      </v-list-tile>
    </v-list>
  </v-navigation-drawer>
</template>
